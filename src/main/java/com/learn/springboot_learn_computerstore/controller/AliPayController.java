...
import com.learn.springboot_learn_computerstore.config.AlipayConfig;
import com.learn.springboot_learn_computerstore.service.IOrderService;
...
public class AliPayController {
    ...
    public String goAlipay(String oid,String totalPrice,HttpServletRequest request) throws Exception {
        ...
        AlipayClient alipayClient = new DefaultAlipayClient(
            alipayConfig.getGatewayUrl(),//gatewayUrl, 
            alipayConfig.getAppId(),//appId,
            alipayConfig.getAppPrivateKey(),//appPrivateKey, 
            "json", 
            alipayConfig.getCharset(),//charset, 
            alipayConfig.getAlipayPublicKey(),//alipayPublicKey,
            alipayConfig.getSignType()//signType
        );
